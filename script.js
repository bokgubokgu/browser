...
const requestInfo = {
    "의뢰1": "의뢰1의 상세 설명입니다.<br>여기에 길게 의뢰 내용을 적으면 됨.",
    "의뢰2": "의뢰2의 상세 설명입니다.<br>여기에 길게 의뢰 내용을 적으면 됨.",
    "의뢰3": "의뢰3의 상세 설명입니다.<br>여기에 길게 의뢰 내용을 적으면 됨.",
...
function renderResults(list){
    ...
    resultsArea.innerHTML = list.map((item, index) => `
        <div class="result-card" data-index="${index}">
            ...
            <div class="result-preview">${escapeHtml(
                item.body
                    .replace(/<br\s*\/?>/gi, " ")
                    .replace(/<a\b[^>]*>/gi, "")
                    .replace(/<\/a>/gi, "")
